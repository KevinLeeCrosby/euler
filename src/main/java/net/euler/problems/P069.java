...
public class P069 {
  ...
  public static void main(String[] args) {
    ...
    for (long n = 2; n <= limit; n++) {
      long phi = primes.totient(n);
      double ratio = (double) n / phi;
      if (bestRatio < ratio) {
        bestRatio = ratio;
        bestN = n;
      }
      //System.out.println(String.format("%d\t%d\t%.2f", n, phi, ratio));
    }

    System.out.println("The value of n ≤ " + limit + " for which n/φ(n) is a maximum is " + bestN);
  }
}
