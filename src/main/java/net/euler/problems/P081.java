...
public class P081 {
  ...
  public static void main(String[] args) {
    String file = "/net/euler/problems/p081.txt";
    InputStream is = P081.class.getResourceAsStream(file);
    loadMatrix(is);

    int minimalPathSum = aStar();
    System.out.println("The minimal path sum in " + m + " by " + n
        + " matrix, from the top left to the bottom right by only moving right and down is " + minimalPathSum);
  }
}
