 ...
 */
public class P097 {
  private static final long MULTIPLIER = 28433, BASE = 2, EXPONENT = 7830457, ADDEND = 1, MODULUS = 10000000000L;

  public static void main(String[] args) {
    long modPrime = (MULTIPLIER * modPow(BASE, EXPONENT, MODULUS)) % MODULUS + ADDEND;

    System.out.println(modPrime);
  }
}
